...
public class rquestion1 extends JFrame {

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	public LinkedList<String> qs=new LinkedList<String>();
	public LinkedList<String> ans=new LinkedList<String>();
	static rquestion1 frame = new rquestion1();
	...
	public rquestion1() {
		...
		a5.setBounds(193, 367, 452, 16);
		panel.add(a5);
		
		JLabel lblNewLabel = new JLabel("Medium NBA rules");
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setFont(new Font("Helvetica", Font.BOLD, 39));
		lblNewLabel.setBounds(135, 6, 358, 52);
